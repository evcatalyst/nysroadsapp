...
- (void)drawRect:(CGRect)rect{
    ...
    int relativeParentXPosition = 135;
    int offsetFromParentY= -7;
    int CalloutMapAnnotationViewHeightAboveParent = 2.0f;
    int CalloutMapAnnotationViewBottomShadowBufferSize = 6.0f;
    int yShadowOffset = 6;
    ...
    CGFloat parentX = relativeParentXPosition;
    //Determine Size
    rect = self.bounds;
    rect.size.width -= stroke + 14;
    rect.size.height -= stroke + CalloutMapAnnotationViewHeightAboveParent - offsetFromParentY + CalloutMapAnnotationViewBottomShadowBufferSize;
